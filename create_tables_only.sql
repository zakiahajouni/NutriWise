-- Script pour créer uniquement les tables dans la base de données nutriwise
-- Exécutez avec: mysql -u nutriwise -p nutriwise < create_tables_only.sql
-- OU: sudo mysql nutriwise < create_tables_only.sql
